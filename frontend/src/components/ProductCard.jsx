  ...
  return (
    <>
      <div
        ...
        className="group relative aspect-[3/4] overflow-hidden cursor-pointer rounded-sm border border-[#E5E0D8] hover:border-teal/40 transition-all duration-500 shadow-sm hover:shadow-lg"
        ...
        <div className="absolute bottom-0 left-0 right-0 p-5 translate-y-2 group-hover:translate-y-0 transition-transform duration-500">
          ...
          <div className="mt-3 opacity-0 group-hover:opacity-100 transition-opacity duration-500 delay-200">
            <button
              ...
              className="ripple-container text-xs uppercase tracking-[0.2em] font-medium text-teal-dark border border-teal/40 px-4 py-2 hover:bg-teal hover:text-white transition-all duration-300 font-body"
            ...
            <div className="p-6 flex flex-col justify-center">
              ...
              <div className="mt-5 space-y-4">
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <p className="text-xs uppercase tracking-[0.2em] font-medium text-[#2D2D2D]/70 mb-1 font-body">Min. Order</p>
                    <p className="text-sm text-[#2D2D2D]/50 font-body font-light">{product.minOrder}</p>
                  </div>
                </div>
              </div>
